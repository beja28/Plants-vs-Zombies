...
public class Messages {
	...
	public static final String DOBLE_PEASHOOTER_NAME_SHORTCUT = "[DP]eashooter";

	public static final String PEASHOOTER_SYMBOL = "P";
	
	public static final String DOBLE_PEASHOOTER_SYMBOL = "DP";

	public static final String PEASHOOTER_NAME = "Peashooter";
	
	public static final String DOBLE_PEASHOOTER_NAME = "Doble Peashooter";
	...
	public static final String COMMAND_FIRE_WAVE_NAME = "FireWave";

	public static final String COMMAND_FIRE_WAVE_SHORTCUT = "fw";
